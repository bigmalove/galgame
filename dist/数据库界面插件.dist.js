(() => {
  ...
  var STORE_IMAGE_PACKS = "imagePacks";
  ...
  var BG_TRANSITION_MS = 450;
  var WORLDBOOK_NAME = "galgame\u754C\u9762\u63D2\u4EF6";
  var COT_ENTRY_NAME = "Galgame\u8F93\u51FA\u683C\u5F0F\u89C4\u8303";
  var EXPRESSION_LIST = ["\u9ED8\u8BA4", "\u5FAE\u7B11", "\u751F\u6C14", "\u96BE\u8FC7", "\u60CA\u8BB6", "\u5632\u8BBD", "\u5BB3\u7F9E", "\u601D\u8003", "\u5927\u7B11", "\u641E\u602A"];
  var EXPRESSION_TAG_MAP = {
  ...
  var RE_THINK_UNCLOSED = /<(think|thinking)>[\s\S]*$/gi;
  var RE_PRE_TAG = /<pre[^>]*>/gi;
  var RE_PRE_CLOSE = /<\/pre>/gi;
  var RE_CODE_TAG = /<code[^>]*>/gi;
  var RE_CODE_CLOSE = /<\/code>/gi;
  ...
  var RE_BGM = /<bgm>(?:当前bgm[:：])?(.+?)<\/bgm>/i;
  var RE_OPTION = /<option\s+id="([^"]+)"[^>]*>([^<]+)<\/option>/gi;
  var RE_P_TAG = /<p(?:\s[^>]*)?>[\s\S]*?<\/p>/gi;
  var PARSE_CACHE_MAX_SIZE = 30;

  // src/core/env.js
  var topWindow = typeof window.parent !== "undefined" ? window.parent : window;
  var $ = topWindow.jQuery || window.jQuery;
  ...
  var characterSprites = GalgameStore.cache.sprites;
  var sceneBackgrounds = GalgameStore.cache.backgrounds;
  var messageSegmentState = GalgameStore.cache.segments;
  var sessionVoiceCache = GalgameStore.cache.voices;
  var parseCache = GalgameStore.cache.parse;
  var enhancedModeState = GalgameStore.enhancedMode;
  var worldbookInjectionState = GalgameStore.worldbookInjection;
  ...
  var CUSTOM_TIME_HTML_KEY = GalgameStore.STORAGE_KEYS.CUSTOM_TIME_HTML;
  var COMFYUI_SETTINGS_KEY = GalgameStore.STORAGE_KEYS.COMFYUI_SETTINGS;
  var COMFY_WORKFLOWS_KEY = GalgameStore.STORAGE_KEYS.COMFY_WORKFLOWS;
  var CHAR_APPEARANCE_PROMPTS_KEY = GalgameStore.STORAGE_KEYS.CHAR_APPEARANCE;

  // src/core/settings.js
  var DEFAULT_COMFYUI_SETTINGS = {
...
\u8FD9\u662F\u683C\u5F0F\u5316\u4EFB\u52A1\uFF0C\u4E0D\u662F\u521B\u4F5C\u4EFB\u52A1\u3002\u4F60\u6536\u5230\u7684\u6587\u672C\u5DF2\u7ECF\u662F\u5B8C\u6574\u7684\uFF0C\u4E0D\u9700\u8981\u4E5F\u4E0D\u5141\u8BB8\u7EE7\u7EED\u5199\u4E0B\u53BB\u3002`;
  ...
  function getCurrentCharId() {
    var _a, _b;
    try {
      const ctx = (_b = (_a = topWindow.SillyTavern) === null || _a === void 0 ? void 0 : _a.getContext) === null || _b === void 0 ? void 0 : _b.call(_a);
      if ((ctx === null || ctx === void 0 ? void 0 : ctx.characterId) !== void 0) {
  ...
  function loadSettings() {
    ...
    const CHAR_ENABLED_STORAGE_KEY2 = GalgameStore.STORAGE_KEYS.CHAR_ENABLED;
    try {
      ...
      if (saved) {
        ...
        if (_settings.wallhaven) {
          if (_settings.wallhaven.cgMode === void 0 && _settings.wallhaven.sceneMode !== void 0) {
    ...
    try {
      const savedChar = topWindow.localStorage.getItem(CHAR_ENABLED_STORAGE_KEY2);
      if (savedChar) {
  ...
  function saveCharEnabled() {
    const CHAR_ENABLED_STORAGE_KEY2 = GalgameStore.STORAGE_KEYS.CHAR_ENABLED;
    try {
      topWindow.localStorage.setItem(CHAR_ENABLED_STORAGE_KEY2, JSON.stringify(_charEnabledMap));
    } catch (e) {
  ...
  // src/core/state.js
  var _db = null;
  var _lastGalgameOptionHash = null;
  var _galgameChoicesVisible = false;
  var _pendingOptions = null;
  var _isEnabled = false;
  var _hideOtherFloors = false;
  var _isSkipping = false;
  var _skipTimer = null;
  var _isRewinding = false;
  var _rewindTimer = null;
  var _rewindHoldTimer = null;
  var REWIND_HOLD_DELAY = 3e3;
  function getDb() {
    return _db;
  }
  function setDb(v) {
  ...
  function setIsEnabled(v) {
    _isEnabled = v;
  }
  function getHideOtherFloors() {
    return _hideOtherFloors;
  }
  function setHideOtherFloors(v) {
    _hideOtherFloors = v;
  }
  function getIsSkipping() {
    return _isSkipping;
  }
  function setIsSkipping(v) {
    _isSkipping = v;
  }
  function getSkipTimer() {
    return _skipTimer;
  }
  function setSkipTimer(v) {
    _skipTimer = v;
  }
  function getIsRewinding() {
    return _isRewinding;
  }
  function setIsRewinding(v) {
    _isRewinding = v;
  }
  function getRewindTimer() {
    return _rewindTimer;
  }
  function setRewindTimer(v) {
    _rewindTimer = v;
  }
  function getRewindHoldTimer() {
    return _rewindHoldTimer;
  }
  function setRewindHoldTimer(v) {
    _rewindHoldTimer = v;
  }
  function getLastGalgameOptionHash() {
    return _lastGalgameOptionHash;
  }
  function setLastGalgameOptionHash(v) {
    _lastGalgameOptionHash = v;
  }
  function getGalgameChoicesVisible() {
    return _galgameChoicesVisible;
  }
  function setGalgameChoicesVisible(v) {
    _galgameChoicesVisible = v;
  }
  function getPendingOptions() {
    return _pendingOptions;
  }
  function setPendingOptions(v) {
    _pendingOptions = v;
  }
  ...
  function getCharacterListFromDatabase() {
    ...
    const characters = [];
    try {
      const charName = (_h = (_d = (_c = (_b = (_a = topWindow.SillyTavern) === null || _a === void 0 ? void 0 : _a.getContext) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.characters) === null || _d === void 0 ? void 0 : _d[(_g = (_f = (_e = topWindow.SillyTavern) === null || _e === void 0 ? void 0 : _e.getContext) === null || _f === void 0 ? void 0 : _f.call(_e)) === null || _g === void 0 ? void 0 : _g.characterId]) === null || _h === void 0 ? void 0 : _h.name;
      if (charName) {
        characters.push({
          id: "current_char",
          name: charName,
  ...
  var CUSTOM_EXPRESSIONS_STORAGE_KEY2 = GalgameStore.STORAGE_KEYS.CUSTOM_EXPRESSIONS;
  function getCustomExpressions() {
    try {
      const saved = topWindow.localStorage.getItem(CUSTOM_EXPRESSIONS_STORAGE_KEY2);
      if (saved) {
        const parsed = JSON.parse(saved);
  ...
  function saveCustomExpressions(expressions) {
    try {
      topWindow.localStorage.setItem(CUSTOM_EXPRESSIONS_STORAGE_KEY2, JSON.stringify(expressions));
    } catch (e) {
      console.warn(`[${SCRIPT_NAME}] \u4FDD\u5B58\u81EA\u5B9A\u4E49\u8868\u60C5\u5931\u8D25:`, e);
    }
  }
  async function addCustomExpression(name, emotion = null) {
  ...
  async function updateCustomExpressionEmotion(name, emotion) {
    const customs = getCustomExpressions();
  ...
  async function removeCustomExpression(name) {
    const customs = getCustomExpressions();
  ...
  function updateLocationTimeDisplay(retryCount = 0) {
    ...
    if (isEmpty && retryCount < 10) {
      setTimeout(() => updateLocationTimeDisplay(retryCount + 1), 1e3);
      return;
    }
    const locationParts = [];
  ...
  async function deleteLive2DModel(characterId) {
    if (!getDb()) await initDB();
    const db = getDb();
    return new Promise((resolve, reject) => {
      try {
  ...
  async function hasLive2DModel(characterId) {
  ...
  async function getAllLive2DModels() {
    if (!getDb()) await initDB();
    const db = getDb();
    return new Promise((resolve) => {
      try {
  ...
  async function getAllImagePacks() {
    if (!getDb()) await initDB();
    const db = getDb();
    return new Promise((resolve, reject) => {
  ...
  async function renameImagePack(packId, newName) {
    if (!getDb()) await initDB();
    const db = getDb();
  ...
  async function deleteImagePack(packId) {
    if (!getDb()) await initDB();
    const db = getDb();
    if (packId === DEFAULT_PACK_ID) {
  ...
  async function transferBackgroundsToPack(sceneNames, targetPackId) {
    if (!getDb()) await initDB();
    const db = getDb();
    let count = 0;
    return new Promise((resolve, reject) => {
  ...
  async function saveSpritesBatch(spritesList, packId = null) {
  ...
  // src/db/backgrounds.js
  async function saveBackground(sceneName, imageBlob, imageUrl = null, packId = null) {
    if (!getDb()) await initDB();
    const db = getDb();
    const targetPackId = packId || getCurrentPackId();
    return new Promise((resolve, reject) => {
  ...
  async function saveBackgroundsBatch(backgroundsList, packId = null) {
  ...
  async function getAllBackgrounds(packId = null, ignorePackFilter = false) {
    if (!getDb()) await initDB();
    const db = getDb();
    return new Promise((resolve) => {
      const transaction = db.transaction([STORE_BACKGROUNDS], "readonly");
  ...
  // src/animation/sprite-animation.js
  var SpriteAnimationManager = {
    ...
    playExpressionTransition(element, callback) {
      ...
      tl.to(el, { scale: 1.02, filter: "brightness(1.15)", duration: 0.1, ease: "power2.out" }).to(el, { scale: 1, filter: "brightness(1)", duration: 0.25, ease: "elastic.out(1, 0.5)" });
    },
    playEmotionAnimation(element, emotion, characterId) {
      ...
      switch (emotion) {
        case "happy":
          ...
          emotionTl.to(el, { y: -15, duration: 0.15, ease: "power2.out" }).to(el, { y: 0, duration: 0.3, ease: "bounce.out" }).to(el, { scale: 1.03, duration: 0.1 }, 0).to(el, { scale: 1, duration: 0.2 }, 0.25);
          break;
        case "angry":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { x: -5, duration: 0.05 }).to(el, { x: 5, duration: 0.05 }).to(el, { x: -4, duration: 0.05 }).to(el, { x: 4, duration: 0.05 }).to(el, { x: -2, duration: 0.05 }).to(el, { x: 0, duration: 0.05 }).to(el, { filter: "saturate(1.2) brightness(1.05)", duration: 0.1 }, 0).to(el, { filter: "saturate(1) brightness(1)", duration: 0.3 }, 0.3);
          break;
        case "sad":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { y: 8, scale: 0.98, duration: 0.4, ease: "power2.out" }).to(el, { rotation: -1, duration: 0.8, ease: "sine.inOut" }).to(el, { rotation: 1, duration: 0.8, ease: "sine.inOut" }).to(el, { y: 0, scale: 1, rotation: 0, duration: 0.5, ease: "power2.out" });
          break;
        case "surprised":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { y: -10, scale: 1.08, duration: 0.12, ease: "power3.out" }).to(el, { y: 0, scale: 1, duration: 0.4, ease: "elastic.out(1, 0.4)" });
          break;
        case "shy":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { scale: 0.96, rotation: -3, duration: 0.2, ease: "power2.out" }).to(el, { rotation: 2, duration: 0.3, ease: "sine.inOut" }).to(el, { rotation: -1, duration: 0.25, ease: "sine.inOut" }).to(el, { scale: 1, rotation: 0, duration: 0.3, ease: "power2.out" });
          break;
        case "think":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { rotation: 5, y: -5, duration: 0.4, ease: "power2.out" }).to(el, { y: -3, duration: 0.6, ease: "sine.inOut", yoyo: true, repeat: 1 }).to(el, { rotation: 0, y: 0, duration: 0.3, ease: "power2.out" });
          break;
        case "laugh":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { scale: 1.05, duration: 0.1 }).to(el, { y: -3, duration: 0.08, yoyo: true, repeat: 5, ease: "none" }).to(el, { scale: 1, y: 0, duration: 0.2, ease: "power2.out" });
          break;
        case "mock":
          emotionTl = this.gsap.timeline();
          emotionTl.to(el, { scaleX: 1.03, rotation: -2, duration: 0.15 }).to(el, { rotation: 2, duration: 0.2, ease: "sine.inOut" }).to(el, { rotation: -1, duration: 0.15, ease: "sine.inOut" }).to(el, { scaleX: 1, rotation: 0, duration: 0.2, ease: "power2.out" });
          break;
        default:
          return;
      }
    ...
    playEnterAnimation(element, direction, characterId, callback) {
      ...
      tl.to(el, { x: 0, y: 0, opacity: 1, scale: 1, duration: 0.5, ease: "back.out(1.2)" }).to(el, { y: 3, duration: 0.08, ease: "power2.in" }).to(el, { y: 0, duration: 0.15, ease: "power2.out" });
    },
  ...
  function updateLive2DConfig(characterId, partialConfig) {
    ...
    const newConfig = {
      ...
      expressionMapping: partialConfig.expressionMapping !== void 0 ? partialConfig.expressionMapping : currentConfig.expressionMapping,
      motionMapping: partialConfig.motionMapping !== void 0 ? partialConfig.motionMapping : currentConfig.motionMapping
    };
  ...
  var _lwbTtsCache = null;
  var _lwbTtsCacheTime = 0;
  var LWB_TTS_CACHE_MS = 5e3;
  ...
  function getTTSEnabled() {
    try {
      const saved = localStorage.getItem(TTS_ENABLED_KEY2);
  ...
  function setTTSEnabled(enabled) {
    try {
      localStorage.setItem(TTS_ENABLED_KEY2, String(enabled));
    } catch (e) {
  ...
  function getAllCharacterTTSVoices() {
    try {
      return JSON.parse(localStorage.getItem(CHAR_TTS_VOICE_KEY2) || "{}");
    } catch (e) {
      return {};
    }
  }

  // src/image-gen/comfyui-helpers.js
  var _getSpriteRef = null;
  function setComfyUIHelperRefs({ getSprite: getSprite2 }) {
    _getSpriteRef = getSprite2;
  }
  var CHAR_APPEARANCE_PROMPTS_KEY2 = GalgameStore.STORAGE_KEYS.CHAR_APPEARANCE;
  var COMFY_WORKFLOWS_KEY2 = GalgameStore.STORAGE_KEYS.COMFY_WORKFLOWS;
  function getCharAppearancePrompts() {
    try {
      const saved = topWindow.localStorage.getItem(CHAR_APPEARANCE_PROMPTS_KEY2);
  ...
  function saveCharAppearancePrompts(prompts) {
    try {
      topWindow.localStorage.setItem(CHAR_APPEARANCE_PROMPTS_KEY2, JSON.stringify(prompts));
    } catch (e) {
...
${lines.join("\n")}`;
  ...
  function getComfyWorkflows() {
    try {
      const saved = topWindow.localStorage.getItem(COMFY_WORKFLOWS_KEY2);
      if (saved) return JSON.parse(saved);
    } catch (e) {
  ...
  function saveComfyWorkflows(workflows) {
    try {
      topWindow.localStorage.setItem(COMFY_WORKFLOWS_KEY2, JSON.stringify(workflows));
    } catch (e) {
      console.warn(`[${SCRIPT_NAME}] \u4FDD\u5B58\u5DE5\u4F5C\u6D41\u5931\u8D25:`, e);
    }
  }

  // src/image-gen/wallhaven-api.js
  var WallhavenAPI = {
    ...
    buildSearchQuery(tags, options = {}) {
      ...
      if (tags && tags.length > 0) {
        let filteredTags = tags.map((t) => t.trim().toLowerCase()).filter((t) => t.length > 0 && t.length < 15).slice(0, 4);
        const similarTags = {
    ...
    async _doSearch(tags, options = {}) {
      ...
      await this.throttle();
      try {
        const queryString = Object.entries(params).filter(([k, v]) => v !== void 0 && v !== null && v !== "").map(([k, v]) => `${k}=${encodeURIComponent(String(v))}`).join("&");
  ...
  var Live2DManager = {
    ...
    // characterId -> PIXI.Live2DModel
    containers: /* @__PURE__ */ new Map(),
    // characterId -> { app, canvas }
    loadingModels: /* @__PURE__ */ new Map(),
    // characterId -> Promise<PIXI.Live2DModel|null>
    renderLocks: /* @__PURE__ */ new Map(),
    ...
    _normalizeTransform(characterId, transformConfig, containerWidth, containerHeight) {
      ...
      const safeTransform = {
        ...
        scale: Number(transformConfig?.scale) || 1,
      ...
      if (rawScaleBase !== void 0 && rawScaleBase !== normalizedScaleBase) {
        changed = true;
      }
    ...
    async _buildModelBlobUrl(modelData, characterId) {
      ...
      if (isModel3) {
        ...
        if (modelData.motions && Object.keys(modelData.motions).length > 0) {
          const motionMap = /* @__PURE__ */ new Map();
        ...
        if (Array.isArray(modelData.expressions) && modelData.expressions.length > 0) {
          const exprMap = /* @__PURE__ */ new Map();
    ...
    async renderTo(characterId, containerElement, forceReload = false) {
      ...
      try {
        ...
        if (containerElement && containerElement.isConnected) {
          let model2 = this.models.get(characterId);
          if (!model2) {
            model2 = await this.loadModel(characterId, false);
          ...
          if (isStory) {
            const slot = slotEl.classList.contains("slot-right") ? "right" : slotEl.classList.contains("slot-left") ? "left" : "left";
        ...
        const safePadding = Math.min(0.08, Math.max(0, Number(config?.safePadding) || 0.03));
    ...
    enableInteraction(characterId) {
      ...
      if (PIXI.filters && PIXI.filters.OutlineFilter) {
        model.filters = [new PIXI.filters.OutlineFilter(2, 54015)];
      }
      if (container.canvas) {
  ...
  var Live2DStage = {
    ...
    applyTransform(characterId) {
      ...
      const userScale = transformConfig.scale || 1;
      const finalScale = baseScale * userScale * (inst.speaking ? 1.03 : 1);
  ...
  // src/live2d/lip-sync.js
  var _ttsGetProxiedAudioUrlRef = null;
  function setLipSyncRefs({ getProxiedAudioUrl }) {
  ...
  var LipSyncManager = {
    ...
    lastVolume: 0,
    connectedAudioElements: /* @__PURE__ */ new WeakSet(),
    _proxyAudio: null,
    config: {
      fftSize: 256,
      smoothingFactor: 0.5,
  ...
  function setPositionEditorRefs({ getModalMountRoot: getModalMountRoot2 }) {
    if (getModalMountRoot2) _getModalMountRootRef = getModalMountRoot2;
  }
  var Live2DPositionEditor = {
    isActive: false,
    characterId: null,
    originalConfig: null,
    $toolbar: null,
    ...
    resetToDefault() {
      ...
      Live2DManager.setScale(characterId, 1);
  ...
  var Live2DUploader = {
    ...
    async uploadZip(file, characterId) {
      ...
      const isModel2 = !isModel3 && (typeof modelJson?.model === "string" || typeof modelJson?.Model === "string" || Array.isArray(modelJson?.textures) || Array.isArray(modelJson?.expressions) || typeof modelJson?.motions === "object");
      console.log(
        `[${SCRIPT_NAME}] Live2DUploader: \u6A21\u578B\u914D\u7F6E\u89E3\u6790\u5B8C\u6210\uFF0C\u76EE\u5F55: ${modelDir || "\u6839\u76EE\u5F55"}\uFF0C\u7C7B\u578B: ${isModel3 ? "Cubism 3/4" : "Cubism 2.1"}`
      );
      let modelData;
      if (isModel3) {
        modelData = {
          ...
          physics: modelJson.FileReferences?.Physics ? await this._extractFileOptional(zip, modelDir, modelJson.FileReferences.Physics) : null,
          pose: modelJson.FileReferences?.Pose ? await this._extractFileOptional(zip, modelDir, modelJson.FileReferences.Pose) : null,
          uploadTime: Date.now(),
          fileSize: file.size
        };
      } else if (isModel2) {
      ...
      for (const entry of jsonEntries) {
        try {
          ...
          if (json.FileReferences && typeof json.FileReferences === "object") {
            score += 100;
            if (typeof json.FileReferences.Moc === "string") score += 1e3;
    ...
    async _extractExpressions(zip, baseDir, modelJson) {
      ...
      for (const exprDef of exprList) {
        ...
        try {
          const data = await this._extractFile(zip, baseDir, filePath);
          expressions.push({ name: name || filePath, file: filePath, data });
        } catch (e) {
  ...
  var Live2DLazyLoader = {
    loadingQueue: /* @__PURE__ */ new Set(),
    maxConcurrent: 2,
...
* \u8FD9\u4E0D\u4EC5\u589E\u52A0\u4E86\u771F\u5B9E\u611F\uFF0C\u8FD8\u4E3A\u9AD8\u88F8\u9732\u5EA6\u63D0\u4F9B\u4E86\u5408\u7406\u7684"\u903B\u8F91\u501F\u53E3"\u3002`
  ...
  var TTSManager = {
    ...
    async speak(segment, segmentId) {
      ...
      if (!resolvedVoice) {
        ...
        if (provider === TTS_PROVIDER.GPT_SOVITS_V2) {
          if (_showToastRef4) _showToastRef4("GPT-SoVITS: \u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u914D\u7F6E\u97F3\u8272\u5217\u8868");
        }
        return;
      }
      console.log(
  ...
  var BGMManager = {
    ...
    isPlaying: false,
    userPaused: false,
    generatingScenes: /* @__PURE__ */ new Set(),
    async init() {
      ...
      this.audio.addEventListener("error", (e) => {
        ...
        if (_showToastRef5) _showToastRef5("BGM\u64AD\u653E\u51FA\u9519");
        this.isPlaying = false;
        this.updateUI();
      });
    },
    ...
    async play(keyword) {
      ...
      if (!track) {
        if (_showToastRef5) _showToastRef5(`\u6B63\u5728\u641C\u7D22BGM: ${keyword}...`);
        try {
        ...
        if (track && track.Url) {
          ...
          if (_showToastRef5) _showToastRef5(`\u672A\u627E\u5230BGM: ${keyword}`);
          return;
        }
      }
      if (track && track.Url) {
        ...
        try {
          ...
          if (_showToastRef5) _showToastRef5(`\u64AD\u653EBGM: ${track.Name || track.name || keyword}`);
        } catch (e) {
  ...
  var ComfyUIAPI = {
    ...
    isTextNode(node) {
      ...
      return type === "CLIPTextEncode" || type === "CLIPTextEncodeSDXL" || type === "ShowText" || type === "PrimitiveNode" || type && type.includes("TextEncode");
    },
    findSamplerNodes(workflow) {
      const samplers = [];
      for (const id in workflow) {
        const node = workflow[id];
        if (node.class_type && (node.class_type.includes("Sampler") || node.class_type === "KModel" || node.class_type === "Samplers")) {
    ...
    injectPromptsToWorkflow(workflow, positive, negative, seed) {
      ...
      if (samplers.length > 0) {
        ...
        for (const { id: samplerId, node: samplerNode } of samplers) {
          if (samplerNode.inputs) {
            if (samplerNode.inputs.seed !== void 0) samplerNode.inputs.seed = seed;
            if (samplerNode.inputs.noise_seed !== void 0) samplerNode.inputs.noise_seed = seed;
          }
      ...
      for (const id in workflow) {
        ...
        if (workflow[id].inputs && (workflow[id].inputs.seed !== void 0 || workflow[id].inputs.noise_seed !== void 0)) {
    ...
    async generate(workflowJson, promptText, negativeText, extraSettings = {}) {
      const s = getComfyUISettings();
      const baseUrl = s.apiUrl.replace(/\/$/, "");
      const seed = Math.floor(Math.random() * 1e13);
      const { checkpointOverride } = extraSettings;
      if (workflowJson.nodes && Array.isArray(workflowJson.nodes) && workflowJson.version !== void 0) {
  ...
  var SpriteManager = {
    ...
    characterQueue: [],
    currentScene: null,
    live2dRenderSeq: /* @__PURE__ */ new Map(),
    emotionMap: {
      "\u9ED8\u8BA4": null,
      "\u5FAE\u7B11": "happy",
      "\u751F\u6C14": "angry",
    ...
    isCharacterElementValid(info, $overlay) {
      return !!(info?.element && info.element.length && info.element[0] && info.element[0].isConnected && (!$overlay?.length || $overlay[0].contains(info.element[0])));
    },
    async rehydrateDisconnectedCharacters($overlay, preferredCharacterId = null, renderToken = null) {
      ...
      for (const [charId, info] of entries) {
        ...
        this.slotOwners.set(info.slot, charId);
        const spriteUrl = _getSpriteRef2 ? await _getSpriteRef2(charId, info.expression || "\u9ED8\u8BA4") : null;
    ...
    removeOldestNonProtagonist() {
      for (let i = 0; i < this.characterQueue.length; i++) {
        ...
        if (!this.isProtagonist(charId) && this.activeCharacters.has(charId)) {
          ...
          if (info.element) {
            info.element.removeClass("speaking silent entering-left entering-center entering-right").addClass(exitClass);
            setTimeout(() => {
              info.element.remove();
    ...
    async updateCharacterSprite($overlay, characterId, expression, spriteUrl, slot, isEntering, renderToken = null) {
      ...
      if (isExistingLive2D && !isEntering) {
        ...
        if (info2) {
          info2.element = $existingContainer;
        }
        return;
      }
      let spriteHtml;
    ...
    async applySceneTint($overlay, scene) {
      ...
      } else if (sceneLower.includes("\u5BA4\u5185") || sceneLower.includes("indoor") || sceneLower.includes("\u623F\u95F4") || sceneLower.includes("\u5C4B")) {
    ...
    clearAll($overlay) {
      ...
      if ($overlay) {
        $overlay.find(".gal-layer-character").html('<div class="gal-char-slot slot-left"></div><div class="gal-char-slot slot-right"></div>');
      }
    },
    reset($overlay) {
  ...
  async function generateCOTTemplate() {
    ...
    if (useBananaImageGen) {
      ...
      let modeHint = "";
      if (bs.cgMode) {
        modeHint = `\u{1F4CC} **CG\u6A21\u5F0F\u5DF2\u5F00\u542F**\uFF1A\u8BF7\u751F\u6210\u7B26\u5408\u5267\u60C5\u7684CG\u753B\u9762\uFF0C\u5FC5\u987B\u5305\u542B\u4EBA\u7269\uFF08\u4E0D\u662F\u5355\u7EAF\u80CC\u666F\uFF09\u3002
...
${customCot}
` : "";
      sceneListText = `**\u{1F34C} \u5927\u9999\u8549 AI \u751F\u56FE\u6A21\u5F0F**: \u5F53\u573A\u666F\u53D8\u5316\u65F6\uFF0C\u4F7F\u7528\u81EA\u7136\u8BED\u8A00\u63CF\u8FF0\u753B\u9762\uFF0C\u7CFB\u7EDF\u5C06\u8C03\u7528 AI \u751F\u6210\u5BF9\u5E94\u80CC\u666F\u56FE\u7247\u3002

${modeHint}
${customCotText}- **\u751F\u6210\u683C\u5F0F**: \`<background scene="\u573A\u666F\u4E2D\u6587\u540D"><bnimg>\u81EA\u7136\u8BED\u8A00\u753B\u9762\u63CF\u8FF0</bnimg>\`
- **\u63CF\u8FF0\u8BED\u8A00**: \u4E2D\u6587\u6216\u82F1\u6587\u5747\u53EF\uFF0C\u5EFA\u8BAE\u4F7F\u7528\u8BE6\u7EC6\u7684\u81EA\u7136\u8BED\u8A00\u63CF\u8FF0

### \u{1F34C} \u5927\u9999\u8549\u63CF\u8FF0\u89C4\u8303\uFF08\u5FC5\u987B\u9075\u5B88\uFF09
...
- \u5E9F\u5F03\u5DE5\u5382 \u2192 "\u8352\u5E9F\u591A\u5E74\u7684\u5DE5\u4E1A\u5382\u623F\uFF0C\u9508\u8FF9\u6591\u6591\u7684\u673A\u5668\u9759\u9ED8\u77D7\u7ACB\uFF0C\u7834\u788E\u7684\u73BB\u7483\u7A97\u900F\u8FDB\u7070\u6697\u7684\u5149\u7EBF\uFF0C\u5730\u4E0A\u6742\u8349\u4E1B\u751F"`;
      ...
      let appearanceHint = "";
      if (ws.cgMode) {
        modeHint = `\u{1F4CC} **CG\u6A21\u5F0F\u5DF2\u5F00\u542F**\uFF1A\u53EF\u4EE5\u5305\u542B\u4EBA\u7269\u76F8\u5173\u5173\u952E\u8BCD\uFF0C\u7279\u522B\u662F\u52A8\u6F2B\u7C7B\u89D2\u8272`;
      } else {
...
\u53EF\u7528\u573A\u666F\u5217\u8868: ${sceneNames.join(", ")}` : `**\u5B9E\u65F6\u573A\u666F\u751F\u6210\u6A21\u5F0F**: \u5F53\u5267\u60C5\u8FDB\u5165\u65B0\u573A\u666F\u65F6\uFF0C\u6839\u636E\u5F53\u524D\u5177\u4F53\u60C5\u8282\u751F\u6210\u65B0\u573A\u666F\u3002
- **\u751F\u6210\u683C\u5F0F**: \`<background scene="\u65B0\u573A\u666F\u540D"><bgimg>visual tags, scenery, indoors/outdoors, lighting, atmosphere, details...</bgimg>\`
...
`;
  ...
  var RE_PRE_TAG2 = /<pre[^>]*>/gi;
  var RE_PRE_CLOSE2 = /<\/pre>/gi;
  var RE_CODE_TAG2 = /<code[^>]*>/gi;
  var RE_CODE_CLOSE2 = /<\/code>/gi;
  ...
  var EXPRESSION_LIST2 = ["\u9ED8\u8BA4", "\u5FAE\u7B11", "\u751F\u6C14", "\u96BE\u8FC7", "\u60CA\u8BB6", "\u5632\u8BBD", "\u5BB3\u7F9E", "\u601D\u8003", "\u5927\u7B11", "\u641E\u602A"];
  var EXPRESSION_TAG_MAP2 = {
    \u9ED8\u8BA4: "neutral expression, looking at viewer",
    \u5FAE\u7B11: "smile, happy, gentle expression",
    \u751F\u6C14: "angry, furrowed brows, intense eyes",
    \u96BE\u8FC7: "sad, tears, sorrowful expression",
  ...
  function preprocessSimplifiedFormat(html) {
    ...
    const sessionVoiceCache2 = GalgameStore.cache.voices;
  ...
  function parseGalgameContent(html, messageId) {
    ...
    if (parseCache2.has(cacheKey)) {
      return parseCache2.get(cacheKey);
    }
    html = html.replace(RE_THINK_CLOSED2, "");
    html = html.replace(RE_THINK_UNCLOSED2, "");
    const result = {
    ...
    const maintextMatch = cleanedHtml.match(RE_MAINTEXT_CLOSED2);
    if (maintextMatch) {
      content = maintextMatch[1];
    } else {
      const maintextStart = cleanedHtml.match(RE_MAINTEXT_UNCLOSED2);
      if (maintextStart) {
    ...
    while ((bgMatch = bgRegex.exec(content)) !== null) {
      ...
      if (bnimgMatch && bnimgMatch.index < bgEndPos + 2e3) {
    ...
    result.segments.forEach((seg) => {
      ...
      if (text) {
        finalSegments.push(Object.assign({}, seg, { text }));
      }
    });
    result.segments = finalSegments;
    if (parseCache2.size >= PARSE_CACHE_MAX_SIZE2) {
      const firstKey = parseCache2.keys().next().value;
      parseCache2.delete(firstKey);
    }
    parseCache2.set(cacheKey, result);
    return result;
  }
  ...
  var _showToastRef7 = null;
  var _updateGlobalOverlayContentRef2 = null;
  ...
  function resetEnhancedModeState() {
    enhancedModeState2.isActive = false;
    enhancedModeState2.stage = "idle";
...
${firstResult}`;
        ...
        if (formattedResult && _updateGlobalOverlayContentRef2) {
          const parsedFormatted = parseGalgameContent(formattedResult);
          if (parsedFormatted.segments.length > 0) {
            await _updateGlobalOverlayContentRef2(numericMessageId, parsedFormatted);
  ...
  function initWorldbookInjectionListener() {
    ...
    if (typeof eventOn === "function" && typeof tavern_events !== "undefined") {
      eventOn(tavern_events.GENERATION_STARTED, async () => {
        ...
        if (currentSettings.enhancedMode?.enabled) {
          ...
          try {
            ...
            if (globalWbs.includes(WORLDBOOK_NAME2)) {
              worldbookInjectionState2.originalWorldbooks = [...globalWbs];
              worldbookInjectionState2.isInjected = true;
              const newWbs = globalWbs.filter((name) => name !== WORLDBOOK_NAME2);
        ...
        try {
          ...
          worldbookInjectionState2.originalWorldbooks = [...globalWbs];
          if (!globalWbs.includes(WORLDBOOK_NAME2)) {
            await rebindGlobalWorldbooks([...globalWbs, WORLDBOOK_NAME2]);
            worldbookInjectionState2.isInjected = true;
            console.log(`[${SCRIPT_NAME}] \u4E16\u754C\u4E66\u6CE8\u5165: \u5DF2\u4E34\u65F6\u9644\u52A0\u811A\u672C\u4E16\u754C\u4E66`);
          } else {
            worldbookInjectionState2.isInjected = false;
      ...
      eventOn(tavern_events.GENERATION_ENDED, async () => {
        ...
        if (worldbookInjectionState2.isInjected && worldbookInjectionState2.originalWorldbooks !== null) {
          try {
            await rebindGlobalWorldbooks(worldbookInjectionState2.originalWorldbooks);
            console.log(`[${SCRIPT_NAME}] \u4E16\u754C\u4E66\u6CE8\u5165: \u5DF2\u6062\u590D\u539F\u59CB\u914D\u7F6E`);
          } catch (e) {
            console.warn(`[${SCRIPT_NAME}] \u6062\u590D\u4E16\u754C\u4E66\u5931\u8D25:`, e);
          }
          worldbookInjectionState2.isInjected = false;
          worldbookInjectionState2.originalWorldbooks = null;
        }
      });
      eventOn(tavern_events.GENERATION_STARTED, () => {
        const timeSinceInit = Date.now() - getInitializationTime();
        if (timeSinceInit < 3e3) {
          console.log(`[${SCRIPT_NAME}] GENERATION_STARTED \u88AB\u5FFD\u7565\uFF08\u9875\u9762\u521A\u52A0\u8F7D ${timeSinceInit}ms\uFF09`);
          return;
        }
        setIsGeneratingResponse(true);
        const generationState2 = getGenerationState();
        generationState2.isGenerating = true;
        generationState2.startTime = Date.now();
        console.log(`[${SCRIPT_NAME}] GENERATION_STARTED - isGeneratingResponse = true`);
        startGenerationTimeout();
        if (_updateNextBtnForGeneratingStateRef2) _updateNextBtnForGeneratingStateRef2();
      });
  ...
  function registerTestFunctions() {
  ...
  async function injectCOTToWorldbook() {
    try {
      const cotTemplate = await generateCOTTemplate();
      const exists = await checkWorldbookExists(WORLDBOOK_NAME2);
      if (!exists) {
        console.log(`[${SCRIPT_NAME}] \u521B\u5EFA\u4E16\u754C\u4E66: ${WORLDBOOK_NAME2}`);
        ...
        let worldbook;
        try {
          worldbook = await getWorldbook(WORLDBOOK_NAME2);
        } catch (getError) {
          console.log(`[${SCRIPT_NAME}] \u4E16\u754C\u4E66\u83B7\u53D6\u5931\u8D25\uFF0C\u53EF\u80FD\u5DF2\u88AB\u5220\u9664\uFF0C\u91CD\u65B0\u521B\u5EFA: ${WORLDBOOK_NAME2}`);
          const cotEntry = buildCotEntry(cotTemplate);
          await createOrReplaceWorldbook(WORLDBOOK_NAME2, [cotEntry]);
        ...
        if (existingEntry) {
          await updateWorldbookWith(WORLDBOOK_NAME2, (entries) => {
            return entries.map((entry) => {
              if (entry.name === COT_ENTRY_NAME2) {
  ...
  async function enableWorldbookGlobally() {
    try {
      ...
      if (globalWorldbooks.includes(WORLDBOOK_NAME2)) {
        console.log(`[${SCRIPT_NAME}] \u4E16\u754C\u4E66\u5DF2\u5168\u5C40\u5F00\u542F`);
        return true;
      }
      const newGlobal = [...globalWorldbooks, WORLDBOOK_NAME2];
  ...
  async function disableWorldbookGlobally() {
    try {
      ...
      const newGlobal = globalWorldbooks.filter((name) => name !== WORLDBOOK_NAME2);
      await rebindGlobalWorldbooks(newGlobal);
  ...
  function parseBananaImageFromResponse(content, proxyUrl) {
    ...
    if (looseUrlMatch && looseUrlMatch[1]) {
      ...
      if (url.includes("image") || url.includes("img") || url.includes("pic") || url.includes("photo") || url.includes("upload") || url.includes("file")) {
  ...
  function handleBananaBackgroundGeneration(sceneName, prompt2) {
    ...
    (async () => {
      try {
        ...
        console.log(`[${SCRIPT_NAME}] \u5927\u9999\u8549\u751F\u56FE: \u539F\u59CB\u63CF\u8FF0 = ${prompt2.substring(0, 100)}...`);
        ...
        if (bs.cgMode) {
          ...
          const appearances2 = getBananaCharacterAppearances();
          if (appearances2.length > 0) {
            const appearanceHint = "\n\n### \u89D2\u8272\u5916\u89C2\u53C2\u8003\uFF08\u5FC5\u987B\u9075\u5B88\uFF09\n" + appearances2.slice(0, 3).map((a) => {
              const name = a.characterName || a.characterId || "\u89D2\u8272";
              const expr = a.expression || "\u9ED8\u8BA4";
  ...
  function injectStyles() {
    ...
    if (!targetDoc.querySelector('link[href*="Noto+Sans+SC"]')) {
      ...
      fontLink.href = "https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@400;500;700;900&family=Barlow:ital,wght@0,400;0,800;1,600&display=swap";
...
`;
  ...
  function getFullscreenElement() {
    return topWindow.document.fullscreenElement || topWindow.document.webkitFullscreenElement || topWindow.document.mozFullScreenElement || topWindow.document.msFullscreenElement || null;
  }
  ...
  function getHistoryFromDatabase() {
    try {
      ...
      for (let i = 1; i < content.length; i++) {
        ...
        if (text) {
          history.push({ index: idx, time, content: text });
        }
      }
      return history;
    } catch (e) {
  ...
  // src/ui/next-btn.js
  var nextBtnAnimationTimer2 = null;
  var NEXT_BTN_ANIMATION_INTERVAL2 = 500;
  function updateNextBtnForGeneratingState() {
    ...
    let dotCount = 1;
    nextBtnAnimationTimer2 = setInterval(() => {
      const dots = "\u3002".repeat(dotCount);
      $nextBtn.html(`${dots} <i class="fa-solid fa-spinner fa-spin"></i>`);
      dotCount = dotCount % 3 + 1;
    }, NEXT_BTN_ANIMATION_INTERVAL2);
  }
  function stopNextBtnAnimation() {
    if (nextBtnAnimationTimer2) {
      clearInterval(nextBtnAnimationTimer2);
      nextBtnAnimationTimer2 = null;
    }
  }
  ...
  function setOverlayContentRefs({ renderGalgameChoices: renderGalgameChoices2 }) {
    if (renderGalgameChoices2) _renderGalgameChoicesRef = renderGalgameChoices2;
  }

  // src/ui/interaction.js
  var messageSegmentState4 = GalgameStore.cache.segments;
  var rewindHoldTimer = null;
  ...
  var isRerolling = false;
  function getIsRerolling() {
    return isRerolling;
  }
  function triggerReroll() {
    ...
    if ($lastMes.length) {
      const mesId = $lastMes.attr("mesid");
      if (mesId) {
        messageSegmentState4.delete(String(mesId));
  ...
  function getRewindHoldTimer2() {
    return rewindHoldTimer;
  }
  function setRewindHoldTimer2(timer) {
    rewindHoldTimer = timer;
  }
  function clearRewindHoldTimer() {
    if (rewindHoldTimer) {
  ...
  `;
    ...
    $widget.find(".gal-bgm-slider").on("input", function(e) {
      e.stopPropagation();
    ...
    BGMManager.updateUI = function() {
      ...
      if (this.currentTrack) {
        const trackName = this.currentTrack.Name || this.currentTrack.name || this.currentTrack.Song || this.currentTrack.song || this.currentTrack.Title || this.currentTrack.title || this.currentKeyword;
  ...
  var _showSettingsPanelRef = null;
  function setMenuButtonRefs({ showSettingsPanel: showSettingsPanel2 }) {
    if (showSettingsPanel2) _showSettingsPanelRef = showSettingsPanel2;
  }
  ...
  var CUSTOM_LOCATION_HTML_KEY2 = "gal_custom_location_html";
  ...
  function setupGlobalEventListeners() {
    ...
    $(doc).on("click", "#gal-location-bar", function(e) {
      e.stopPropagation();
      const customHtml = localStorage.getItem(CUSTOM_LOCATION_HTML_KEY2);
      if (customHtml) showCustomPopupPanel("\u5730\u70B9\u8BE6\u60C5", customHtml);
    });
    $(doc).on("click", "#gal-time-bar", function(e) {
      e.stopPropagation();
      const customHtml = localStorage.getItem(CUSTOM_TIME_HTML_KEY2);
    ...
    $(doc).on("mousedown touchstart", '#gal-global-overlay [data-action="prev"]', function(e) {
      e.stopPropagation();
      e.preventDefault();
      setRewindHoldTimer2(setTimeout(() => {
        startRewinding();
      }, REWIND_HOLD_DELAY));
    });
          ...
          <div class="gal-settings-section">
            ...
            <div id="gal-gpt-sovits-config" style="margin-top: 10px; padding: 12px; border: 1px dashed #ddd; border-radius: 8px; background: #fafafa; ${settings.ttsProvider === "gpt_sovits_v2" ? "" : "display: none;"}">
              ...
              <div class="gal-settings-row">
                ...
                <input type="text" id="gal-gpt-sovits-text-lang" value="${settings.gptSoVits?.textLang || "auto"}" placeholder="auto/zh/en/ja..." style="flex: 1; margin-left: 10px; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 0.85rem;">
              </div>
              <div class="gal-settings-row">
                <span class="gal-settings-label">\u5207\u5206\u7B56\u7565</span>
                <input type="text" id="gal-gpt-sovits-split" value="${settings.gptSoVits?.textSplitMethod || "cut5"}" placeholder="cut5" style="flex: 1; margin-left: 10px; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 0.85rem;">
              </div>
              <div class="gal-settings-row">
              ...
              <div class="gal-settings-row">
                ...
                <label class="gal-switch"><input type="checkbox" id="gal-gpt-sovits-streaming" ${settings.gptSoVits?.streamingMode ?? true ? "checked" : ""}><span class="gal-switch-slider"></span></label>
              </div>
              <div class="gal-settings-row">
                <span class="gal-settings-label">speed_factor</span>
                <input type="number" id="gal-gpt-sovits-speed" value="${settings.gptSoVits?.speedFactor ?? 1}" min="0.5" max="2" step="0.05" style="width: 120px; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 0.85rem;">
              </div>
  ...
  `;
    ...
    $("#gal-dialog-opacity").on("input", function() {
      ...
      $("#gal-dialog-opacity-value").text(t + "%");
      applySettingsToUI();
      saveSettings();
    });
...
${prompts.userPrompt}`).then(() => showToast4("\u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F")).catch(() => showToast4("\u590D\u5236\u5931\u8D25"));
          ...
          <div class="gal-settings-panel" data-panel="transform">
            <div style="margin-bottom: 20px;">
              ...
              <div style="margin-top: 15px;">
                <label style="display: block; margin-bottom: 6px; font-weight: 600; font-size: 0.9rem; color: #333;">\u7F29\u653E\u500D\u7387: <span id="gal-live2d-scale-value">${(transformConfig.scale || 1).toFixed(1)}x</span></label>
                <input type="range" id="gal-live2d-scale" min="0.5" max="2.0" step="0.1" value="${transformConfig.scale || 1}" style="width: 100%;">
              </div>
              <div style="margin-top: 15px;">
          ...
          <div class="gal-settings-panel" data-panel="quality" style="display: none;">
            <div style="margin-bottom: 20px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                  <input type="radio" name="textureResolution" value="1.0" ${!qualityConfig.textureResolution || qualityConfig.textureResolution === 1 ? "checked" : ""}>
                  <span>\u6B63\u5E38 (1.0x) - \u63A8\u8350</span>
                </label>
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                  <input type="radio" name="textureResolution" value="2.0" ${qualityConfig.textureResolution === 2 ? "checked" : ""}>
            ...
            <div style="margin-bottom: 20px;">
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                ...
                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer;">
                  <input type="radio" name="devicePixelRatio" value="1.0" ${qualityConfig.devicePixelRatio === 1 ? "checked" : ""}>
                  <span>1.0</span>
                </label>
                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer;">
                ...
                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer;">
                  <input type="radio" name="devicePixelRatio" value="2.0" ${qualityConfig.devicePixelRatio === 2 ? "checked" : ""}>
                  <span>2.0</span>
                </label>
              </div>
            </div>
  ...
  `;
    ...
    $modal.find("#gal-live2d-reset-transform").on("click", function() {
      ...
      $modal.find("#gal-live2d-scale").val(1);
    ...
    $modal.find("#gal-live2d-start-position-edit").on("click", async function() {
      const currentTransform = {
        ...
        scale: parseFloat($modal.find("#gal-live2d-scale").val()) || 1,
    ...
    $modal.find("#gal-live2d-settings-save").on("click", function() {
      ...
      const newQuality = {
        textureResolution: parseFloat($modal.find('input[name="textureResolution"]:checked').val()) || 1,
  ...
  // src/ui/sprite-config.js
  var _showBatchUploadDialogRef = null;
  var _showSpriteUploadDialogRef3 = null;
  var _showBackgroundUploadDialogRef = null;
  function setSpriteConfigRefs({ showBatchUploadDialog: showBatchUploadDialog2, showSpriteUploadDialog: showSpriteUploadDialog2, showBackgroundUploadDialog: showBackgroundUploadDialog2 }) {
    if (showBatchUploadDialog2) _showBatchUploadDialogRef = showBatchUploadDialog2;
    if (showSpriteUploadDialog2) _showSpriteUploadDialogRef3 = showSpriteUploadDialog2;
    if (showBackgroundUploadDialog2) _showBackgroundUploadDialogRef = showBackgroundUploadDialog2;
  }
  async function showSpriteConfigModal() {
    ...
    request.onsuccess = async () => {
      ...
      if (dbCharacters.length > 0) {
        charactersHtml = `
          ...
          return `
                  <div class="gal-sprite-card ${hasSprite ? "" : "no-sprite"}"
                    ...
                    ${hasSprite ? `<img class="gal-sprite-preview" src="${blobUrl}" alt="${char.name}">` : `<div class="gal-sprite-preview" style="display: flex; align-items: center; justify-content: center; color: #aaa;">
        ...
        charactersHtml = `
          <div style="padding: 30px; text-align: center; color: #888; background: #f5f5f5; margin-bottom: 20px; border-radius: 8px;">
            ...
            <small>\u8BF7\u786E\u4FDD \u795E\xB7\u6570\u636E\u5E93 \u811A\u672C\u5DF2\u52A0\u8F7D\u5E76\u5305\u542B\u89D2\u8272\u4FE1\u606F</small>
          </div>
        `;
      }
      const backgrounds = await getAllBackgrounds();
      const backgroundsHtml = backgrounds.length > 0 ? backgrounds.map((bg) => {
      ...
      $("#gal-add-sprite").on("click", async () => {
        $modal.remove();
        if (_showSpriteUploadDialogRef3) await _showSpriteUploadDialogRef3("default", "\u9ED8\u8BA4", () => showSpriteConfigModal());
      });
  ...
  function showBackgroundUploadDialog(onCloseCallback) {
    ...
    $("#gal-bg-comfyui-generate-btn").on("click", async function() {
      ...
      const positive = [prompt2, "scenery, background, no humans, masterpiece, best quality, highres"].join(", ");
      const cs = getComfyUISettings();
      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (!$sceneNameInput.val()) {
            $sceneNameInput.val(prompt2.split(",")[0].substring(0, 10));
            updateConfirmState();
          }
        };
        reader.readAsDataURL(file);
  ...
  async function showBananaAppearancePicker(onSelect) {
    ...
    const blobUrls = [];
    const groupsHtml = Array.from(grouped.entries()).map(([charId, list]) => {
        ...
        return `
                <div class="gal-banana-appearance-item" data-char="${charId}" data-expr="${s.expression}" style="border: 1px solid #334155; border-radius: 8px; padding: 8px; background: #0f172a; cursor: pointer;">
                  <div style="aspect-ratio: 2 / 3; background: #020617; border-radius: 6px; overflow: hidden; margin-bottom: 6px; display: flex; align-items: center; justify-content: center;">
                    ${preview ? `<img src="${preview}" alt="${s.expression}" style="width: 100%; height: 100%; object-fit: cover;">` : `<div style="font-size: 0.75rem; color: #64748b;">\u65E0\u7ACB\u7ED8</div>`}
                  </div>
  ...
  async function showSpriteUploadDialog(characterId, expression, onCloseCallback) {
    const allExpressions = getAllExpressions();
    const expressionOptions = allExpressions.map(
  ...
  function showBatchUploadDialog(characterId, onCloseCallback) {
    ...
    function updateMappingUI() {
      ...
      cellMappings = [];
      const defaultExpressions = [...EXPRESSION_LIST2];
    ...
    function updateAllSelectOptions() {
      const usedExpressions = /* @__PURE__ */ new Set();
      cellMappings.forEach((m) => {
        if (m.expression) usedExpressions.add(m.expression);
      });
                ...
                <div class="gal-input-box" style="max-width: 550px; width: 90%; padding: 25px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <div id="gal-custom-expressions-list" style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 15px; min-height: 40px; border: 1px dashed #ddd; padding: 10px; border-radius: 6px;">
                            ${customExpressions.length > 0 ? customExpressions.map(
      (e) => `
                            ...
                            `
    ).join("") : '<span style="color: #999;">\u6682\u65E0\u81EA\u5B9A\u4E49\u8868\u60C5</span>'}
                        </div>
                        <div style="display: flex; gap: 10px;">
...
\u6CE8\u610F\uFF1A\u8FD9\u4E0D\u4F1A\u5220\u9664\u5DF2\u4F7F\u7528\u8BE5\u8868\u60C5\u7684\u7ACB\u7ED8\u3002`)) {
        removeCustomExpression(exprToRemove).then((success) => {
          if (success) renderCustomExpressions();
        });
      }
    });
    const handleClose = () => {
  ...
  async function showImportPackSelector(suggestedName = null) {
    return new Promise((resolve) => {
  ...
  async function processZipContents(zip, progressController, isCancelledCheck, targetPackId = null) {
  ...
  var _showBackgroundUploadDialogRef2 = null;
  var _showBatchBackgroundUploadDialogRef = null;
  var _showCustomExpressionManagerRef = null;
  var _showBananaAppearancePickerRef = null;
  function setAssetManagerRefs({ showSpriteUploadDialog: showSpriteUploadDialog2, showBatchUploadDialog: showBatchUploadDialog2, showBackgroundUploadDialog: showBackgroundUploadDialog2, showBatchBackgroundUploadDialog: showBatchBackgroundUploadDialog2, showCustomExpressionManager: showCustomExpressionManager2, showBananaAppearancePicker: showBananaAppearancePicker2 }) {
    if (showSpriteUploadDialog2) _showSpriteUploadDialogRef4 = showSpriteUploadDialog2;
    if (showBatchUploadDialog2) _showBatchUploadDialogRef2 = showBatchUploadDialog2;
    if (showBackgroundUploadDialog2) _showBackgroundUploadDialogRef2 = showBackgroundUploadDialog2;
    if (showBatchBackgroundUploadDialog2) _showBatchBackgroundUploadDialogRef = showBatchBackgroundUploadDialog2;
    if (showCustomExpressionManager2) _showCustomExpressionManagerRef = showCustomExpressionManager2;
    if (showBananaAppearancePicker2) _showBananaAppearancePickerRef = showBananaAppearancePicker2;
  }
  var CUSTOM_LOCATION_HTML_KEY3 = GalgameStore.STORAGE_KEYS.CUSTOM_LOCATION_HTML;
  var CUSTOM_TIME_HTML_KEY3 = GalgameStore.STORAGE_KEYS.CUSTOM_TIME_HTML;
  function renderBananaAppearanceList2($modal) {
    const list = getBananaCharacterAppearances();
    const $list = $modal.find("#gal-banana-appearance-list");
    const $empty = $modal.find("#gal-banana-appearance-empty");
    if (!$list.length) return;
    ...
    refreshBananaAppearancePreviews2($modal);
  }
  async function refreshBananaAppearancePreviews2($modal) {
    const $cards = $modal.find(".gal-banana-appearance-card");
    if (!$cards.length) return;
    for (const card of $cards) {
      const $card = $(card);
  ...
  <div class="gal-input-modal" id="gal-character-sprites-modal">
    <div class="gal-input-box" style="max-width: 800px; width: 95%; max-height: 90vh; overflow: hidden; padding: 0; display: flex; flex-direction: column;">
      ...
      <div style="flex: 1; overflow-y: auto; padding: 20px 25px;">
        ...
        ${characterSpritesData.length === 0 ? `<div style="text-align: center; padding: 40px; color: #999;">
  ...
  async function showPackManagerModal() {
    const allPacks = await getAllImagePacks();
    const currentPackId = getCurrentPackId();
...
\u8BE5\u56FE\u5305\u5185\u7684\u6240\u6709\u8D44\u6E90\u5C06\u88AB\u8F6C\u79FB\u5230"\u672A\u5B9A\u4E49"\u56FE\u5305\u3002`)) {
  ...
  async function showTransferDialog(resourceType, resourceIds, onComplete) {
    const allPacks = await getAllImagePacks();
    const currentPackId = getCurrentPackId();
    const modalHtml = `
  ...
  function bindBananaEvents($modal, settings) {
    ...
    $modal.find("#gal-banana-generate-btn").on("click", async function() {
      ...
      if (!cgMode) {
        ...
        if (suffixToUse) finalPrompt = finalPrompt + suffixToUse;
      }
  ...
  function bindPackSelectorEvents($modal, activeTab, allPacks, currentPackId) {
    ...
    $("#gal-render-scope-btn").on("click", function() {
      ...
      $modal.remove();
      $(topWindow.document).off(".galMenus").off(".galImportMenu").off(".galPackMenu");
      showAssetManagerModal2(currentTab);
    });
  }
...
${baseUrl}`)) return;
    ...
    $("#gal-asset-import-zip-input").on("change", async function() {
      ...
      $(this).val("");
      $modal.remove();
      showAssetManagerModal2(activeTab);
    });
      ...
      setTimeout(() => {
        ...
        if (typeof topWindow.eventOn === "function" && topWindow.tavern_events) {
          topWindow.eventOn(topWindow.tavern_events.MESSAGE_RECEIVED, (messageId) => {
            ...
            const generationState2 = getGenerationState();
            generationState2.pendingMessageId = messageId;
            setTimeout(() => {
